          ...
          <form class="row g-3" method="post" action="{{ route('products.update', $product->id) }}" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-12">
                    ...
                    @if ($product->preview)
                        <img src="{{ asset('productphoto/' . $product->preview) }}" style="max-width: 500px; max-height: 500px;" alt="Preview">
                    @endif
                </div>
                <div class="col-md-12">
                ...
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" id="information" name="information" value="{{ old('information', $product->information) }}">
                </div>
